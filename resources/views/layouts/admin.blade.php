            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="{{ $url == 'categories' ? 'active' : '' }}">
                        <a href="{{ url('admin/categories') }}"><i class="menu-icon fa fa-tags"></i> Kategori</a>
                    </li>
                    ...
                    <li class="{{ $url == 'destinations' ? 'active' : '' }}">
                        <a href="{{ url('admin/destinations') }}"><i class="menu-icon fa fa-map-marker"></i>
                            Destinasi / Agenda</a>
                    </li>
                    <li class="{{ $url == 'sejarahs' ? 'active' : '' }}">
                        <a href="{{ url('admin/sejarahs') }}"><i class="menu-icon fa fa-history"></i> Sejarah</a>
                    </li>
                    <li class="{{ $url == 'visimisis' ? 'active' : '' }}">
                        <a href="{{ url('admin/visimisis') }}"><i class="menu-icon fa fa-bullseye"></i> Visi & Misi</a>
                    </li>
                    <li class="{{ $url == 'strukturs' ? 'active' : '' }}">
                        <a href="{{ url('admin/strukturs') }}"><i class="menu-icon fa fa-sitemap"></i> Struktur
                            Organisasi</a>
                    </li>
                    <li class="{{ $url == 'abouts' ? 'active' : '' }}">
                        <a href="{{ url('admin/abouts') }}"><i class="menu-icon fa fa-comments-o"></i> Sambutan
                            Ketua</a>
                    </li>
                    <li class="{{ $url == 'galeris' ? 'active' : '' }}">
                        <a href="{{ url('admin/galeris') }}"><i class="menu-icon fa fa-image"></i> Galeri</a>
                    </li>
                    <li class="{{ $url == 'tentangs' ? 'active' : '' }}">
                        <a href="{{ url('admin/tentangs') }}"><i class="menu-icon fa fa-info-circle"></i> Tentang</a>
                    </li>
                    <li class="{{ $url == 'logos' ? 'active' : '' }}">
                        <a href="{{ url('admin/logos') }}"><i class="menu-icon fa fa-bullseye"></i> Logo dan Makna</a>
                    </li>
                    <li class="{{ $url == 'quotes' ? 'active' : '' }}">
                        <a href="{{ url('admin/quotes') }}"><i class="menu-icon fa fa-quote-left"></i> Quotes</a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <footer class="site-footer">
            <div class="footer-inner bg-white">
                <div class="row">
                    <div class="col-sm-6">
                        Copyright &copy; 2025 Muda Mudi Sukasari
                    </div>
                    <div class="col-sm-6 text-right">
                        Designed by <a href="https://colorlib.com">Awan Setiawan</a>
                    </div>
                </div>
            </div>
        </footer>
